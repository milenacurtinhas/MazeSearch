    ...
    if(d->start_block == -1 && d->end_block == d->blocks_allocd){
        ...
        if(d->end_block + 2 == d->blocks_allocd){
            ...
            if(d->start_block == d->end_block && d->start_idx == d->end_idx){
                ...
                d->start_idx = d->start_idx + (block_size * upper_space);
                d->end_idx = d->start_idx + (block_size * (deque_size - 1));
                ...
                for(int i = 0; i < deque_size; i++){
                    if(prev[i]){
                        new[i+upper_space] = array_calloc();
        ...
        if(d->start_block == 1){
            ...
            if(d->start_block == d->end_block && d->start_idx == d->end_idx){
                ...
                d->end_idx = d->end_idx - (block_size * (bottom_space - 1));
                d->start_block = d->end_idx + (block_size * (deque_size + 1));
